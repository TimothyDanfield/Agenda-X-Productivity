...
const AboutUs = () => {
  return (
    ...
    <Card className='aboutus' >
      ...
      <p className='text' >Team LiveWires is a team of three developers, Nathan Grandinette, Vesper Wetzel and Timothy Danfield. They are working together to create a productivity app that will help people stay organized and productive.</p> <br/>
